      ...
      {isSectionVisible(sections, "cta") && (
        <>
          ...
          <section className="hidden md:flex relative overflow-visible mt-0 px-20 pb-24 -mb-16 flex-row items-center justify-center gap-10">
            <img src={img(images, "dog_left", "dog-left.png")} alt="" className="pointer-events-none absolute left-0 bottom-[-80px] z-30 w-[300px] lg:w-[360px] xl:w-[420px]" />
            ...
            <img src={img(images, "cat", "cat.png")} alt="" className="pointer-events-none absolute right-0 bottom-[-72px] z-30 w-[260px] lg:w-[320px] xl:w-[380px]" />
          </section>
        </>
      )}

        ...
        <>
          ...
          <style>{`
            @media (pointer: coarse) and (max-width: 1600px) {
              .hero-phone-left  { width: 500px !important; margin-right: -50px !important; }
          ...
          <section className="hidden md:flex relative items-center justify-center gap-0 px-6 mt-10">
            <img src={img(images, "arc_left", "arc.png")} alt="" aria-hidden="true" className="hero-arc pointer-events-none select-none absolute left-[15%] bottom-[30px] w-[480px] z-10 opacity-90" />
            <img src={img(images, "arc_right", "arc.png")} alt="" aria-hidden="true" className="hero-arc pointer-events-none select-none absolute right-[14%] bottom-[30px] w-[480px] z-10 opacity-90" />
